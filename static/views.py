...
def index(request):
	if request.is_ajax():
		...
		path = os.path.join(os.path.expanduser('~'), 'Desktop','work-task','FormBuilder','form_builder_app','templates','form_bulider_app', 'file.html')
...
def your_form(request,link_id):
	return render(request,'form_builder_app/file.html')